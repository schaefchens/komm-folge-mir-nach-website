...
const SignupForm = () => {
  ...
  const [currentView, setCurrentView] = useState<FormView>("intent");
      ...
      <div className="container px-6 md:px-12 relative z-10">
        ...
        duration: 0.8
          ...
          <AnimatePresence mode="wait">
            {currentView === "intent" && (
              <motion.div key="checkbox" initial={{
                opacity: 0,
                y: 20
              }} animate={{
                opacity: 1,
                ...
                <div className="relative bg-card rounded-3xl p-12 md:p-16 shadow-elegant border border-border/50">
                  <div className="flex flex-col items-center text-center space-y-8">
                    ...
                    <motion.div whileHover={{
                      ...
                      setTimeout(() => setCurrentView("form"), 300);
                    }}>
                      <Checkbox id="intent" checked={currentView !== "intent"} onCheckedChange={checked => {
                        if (checked) {
                          setTimeout(() => setCurrentView("form"), 300);
                        }
